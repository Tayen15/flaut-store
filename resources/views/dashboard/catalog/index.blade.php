...
<section id="catalog" class="flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
    ...
    <div class="px-2 my-2 md:px-10 max-h-screen w-full overflow-x-auto">
        @if (!$catalogs->isEmpty())
            <table id="catalogTable" class="w-full table-auto text-left">
                <thead>
                    <tr>
                        ...
                        <th class="p-2 md:p-6 border-b border-blue-gray-50">Price</th>
        ...
        @else
            <div class="flex justify-center mt-10 p-5 mx-52">
                <p class="text-2xl font-semibold text-center">No data Available</p>
            </div>
        @endif
    </div>
