    ...
    <div class="max-w-7xl p-6 mx-auto rounded-md shadow-md mt-2">
        <form action="{{ route('dashboard.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div>
                    <label class="text-black font-medium" for="email">Email</label>
                    <input id="email" name="email" type="email" value="{{ auth()->user()->email }}" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md focus:outline-none focus:ring">
                </div>
            </div>
