...
@section('admin')
    <section id="create-Carousel" class="flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        <!-- Page Header -->
        <div class="bg-gray-800 pt-3">
            <div class="flex items-center justify-between rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h1 class="font-bold pl-2">Create Carousel</h1>
            </div>
        </div>
        ...
        <div class="max-w-7xl p-6 mx-auto rounded-md shadow-md mt-2">
            <form action="{{ route('dashboard.carousel.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end mt-6">
                    ...
                    <a href="{{ route('dashboard.carousel.index') }}" class="px-4 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-400 rounded-md hover:bg-gray-500 cursor-pointer focus:outline-none focus:bg-gray-600">Cancel</a>
                </div>
            </form>
        </div>
    </section>
