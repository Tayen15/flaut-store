...
<section id="admin" class="flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="p-2 md:p-6 border-b border-blue-gray-50">
                        ...
                        <button onclick="confirmDelete('{{ $user->id }}')" class="relative align-middle select-none font-medium text-center uppercase transition-all w-10 h-10 md:w-12 md:h-12 rounded-lg text-xs text-gray-900 hover:bg-gray-900/10 active:bg-gray-900/20" type="button" >
                            <span class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
    ...
    <div id="confirmDeleteModal" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-75 flex items-center justify-center hidden">
        <div class="bg-white p-4 rounded-lg">
            ...
            <p class="text-gray-700">Are you sure you want to delete this Admin?</p>
