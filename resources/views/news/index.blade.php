    ...
    <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 mt-20">
        @forelse($news as $item)
            <div class="rounded overflow-hidden shadow-lg max-w-xs">
                <img class="w-full" src="{{ $item->image_url }}" alt="{{ $item->title }}">
                <div class="px-6 py-2">
...
<div class="container my-24 mx-auto md:px-6 p-14 bg-scroll" style="background-image: url('https://cdn.discordapp.com/attachments/976824443743645696/1193148201675526184/download.jpeg?ex=65aba8da&is=659933da&hm=b409f771292a711d2f621606e630ac3a40132c9d011acf468abf86d3129b6c99&')">
