                    ...
                    <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                        <li class="flex-1 md:flex-none md:mr-3">
                            @if (auth()->user()->level > 1)
                                <a class="inline-block py-2 px-4 text-white no-underline" href="{{ route('dashboard.admin.index') }}">Admin</a>
                            @endif
                        </li>
                        <li class="flex-2 md:flex-none md:mr-3">
                            <div class="relative inline-block">
                                ...
                                <div id="myDropdown" class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none invisible">
