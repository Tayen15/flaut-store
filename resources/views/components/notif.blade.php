<div class="notification-container">
    @if (session('success'))
    <div role="alert" data-dismissible="alert" class="relative flex w-full max-w-(--breakpoint-md) px-4 py-3 text-base text-white bg-gray-900 rounded-lg font-regular notification">
        <div class="shrink-0">
