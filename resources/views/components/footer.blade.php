...
<div class="mt-14 mx-auto md:px-6 p-8 bg-fixed w-full mb-5" style="background-image: url('https://cdn.discordapp.com/attachments/976824443743645696/1193148201675526184/download.jpeg?ex=65aba8da&is=659933da&hm=b409f771292a711d2f621606e630ac3a40132c9d011acf468abf86d3129b6c99&')">
...
<div class="mx-6 py-10 text-center md:text-left px-20">
     <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div class=" mt-16">
               <p>
               Kunjungi toko offline kami sekarang dan temukan penawaran yang menggiurkan!
               </p>
