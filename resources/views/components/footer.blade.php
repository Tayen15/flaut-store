...
<div class="mx-6 md:py-10 text-center md:text-left px-20">
     <div class="grid justify-center gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="hidden md:block" id="sectionProducts">
               ...
               <p class="mb-4">
                    <a href="{{ route('catalog.index', ['category' => 't-shirt']) }}" class="text-white-600 dark:text-white-200 hover:text-orange-600">
                         T-Shirt
                    </a>
               </p>
               <p class="mb-4">
                    <a href="{{ route('catalog.index', ['category' => 'shirt']) }}" class="text-white-600 dark:text-white-200 hover:text-orange-600">
                         Shirt
                    </a>
               </p>
               <p class="mb-4">
                    <a href="{{ route('catalog.index', ['category' => 'pants']) }}" class="text-white-600 dark:text-white-200 hover:text-orange-600">
                         Pants
                    </a>
               </p>
               <p>
                    <a href="{{ route('catalog.index', ['category' => 'accessories']) }}" class="text-white-600 dark:text-white-200 hover:text-orange-600">
                         Accessories
                    </a>
               </p>
          </div>
          ...
          <div class="hidden md:block" id="sectionLinks">
               ...
               <p class="mb-4">
                    <a href="{{ route('about-us') }}" class="text-white-600 dark:text-white-200 hover:text-orange-600"
                    >About Us</a
                    >
               </p>
               <p class="mb-4">
